...
import {addFollow, delFollow} from '../../reducer/modules/follow'
import {Alert, Card, Icon, Input, message, Modal, Tooltip} from 'antd'
import {checkProjectName, copyProjectMsg, getProject} from '../../reducer/modules/project'
        ...
        <Card
          ...
          }>
          {
            projectData.logo
              ? (
                <img
                  src={`/api/file/download?id=${projectData.logo}`}
                  className='ui-logo'
                  style={{
                    backgroundColor:
