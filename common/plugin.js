...
function getPluginConfig(name, type) {
  ...
  if (!pluginConfig || typeof pluginConfig !== 'object') {
    throw new Error(`Plugin ${name} Config 配置錯誤，請檢查 yapi-plugin-${name}/index.js`)
  }
...
/**
   * type @string enum[plugin, ext] plugin是外部外掛，ext是內部外掛
   */
exports.initPlugins = function (plugins, type) {
  ...
  if (typeof plugins !== 'object' || !Array.isArray(plugins)) {
    throw new Error('外掛配置有誤，請檢查', plugins)
  }
